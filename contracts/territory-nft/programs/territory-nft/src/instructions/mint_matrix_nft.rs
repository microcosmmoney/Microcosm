...
pub fn handler(ctx: Context<MintMatrixNft>, matrix_id: u64, parent_sector_id: u64, uri: String) -> Result<()> {
    ...
    msg!("Matrix NFT minted: matrix_id={}, mint={}", matrix_id, ctx.accounts.nft_mint.key());
