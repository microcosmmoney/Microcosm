...
pub fn handler(ctx: Context<MintSectorNft>, sector_id: u64, parent_system_id: u64, uri: String) -> Result<()> {
    ...
    msg!("Sector NFT minted: sector_id={}, mint={}", sector_id, ctx.accounts.nft_mint.key());
